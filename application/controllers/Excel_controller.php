...
class Excel_controller extends CI_Controller
{
		...
		function __construct()
	{
		...
		public function student_export(){
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('G1','graduate');
			$objPHPExcel->getActiveSheet()->SetCellValue('H1','elevel');
			$objPHPExcel->getActiveSheet()->SetCellValue('I1','professional');
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('A'.$row, $value['full_name'].' '.$value['phone']);
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('F'.$row, $value['year']);
			$objPHPExcel->getActiveSheet()->SetCellValue('G'.$row, $value['graduate']." %");
			$objPHPExcel->getActiveSheet()->SetCellValue('H'.$row, $value['elevel']);
			$objPHPExcel->getActiveSheet()->SetCellValue('I'.$row, $value['professional']);
		...
		public function mentor_export(){
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('E1','elevel');
			$objPHPExcel->getActiveSheet()->SetCellValue('F1','professional');
			...
			$objPHPExcel->getActiveSheet()->SetCellValue('E'.$row, $value['elevel']);
			$objPHPExcel->getActiveSheet()->SetCellValue('F'.$row, $value['professional']);
