...
if(!defined('BASEPATH'))
    ...
    class Home_model extends CI_Model{
       ...
       /* function check_email($reg_email){
        ...
        function insert_data($reg_full_name, $reg_phone, $reg_email, $reg_password, $user_type){


        	$qry = "INSERT INTO users VALUES ('','$reg_full_name','$reg_phone','$reg_email','$reg_password','$user_type')";
           $this ->db->query($qry);
    ...
    function check_login($log_email, $log_password){
		...
		$result = $this->db->get('users')->result_array();
			...
			//==========TEST (LOGIN INACTIVE ADMN & EMPLOYER)=======
