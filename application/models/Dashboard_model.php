...
//=====================SHOW REQUESTS=============
	...
	{   $this->db->where('id',$id);
        ...
        public function update_password($updated_data, $id){
        ...
        // public function request(){
        // $studentTable = $this->db->table("student");
        // $studentTable->select("elevel, professional");
        // $query = $studentTable->get();

        // echo "<pre>";
        // print_r($query->getRow());

        public function set_about_club ($data)
        {  
           
            $this->db->replace('club',$data);
            return true;
        }
