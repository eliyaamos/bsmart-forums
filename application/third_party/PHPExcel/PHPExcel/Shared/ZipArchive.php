...
class PHPExcel_Shared_ZipArchive
{
     ...
     *
     * @param    string    $locaphone        Directory/Name of the file to add to the zip archive
     * @param    string    $contents        String of data to add to the zip archive
     */
    public function addFromString($locaphone, $contents)
    {
        $filenameParts = pathinfo($locaphone);
