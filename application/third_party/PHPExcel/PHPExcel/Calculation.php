            ...
            if ($locale != 'en_us') {
                ...
                foreach ($localeFunctions as $localeFunction) {
                    ...
                    if (strpos($localeFunction, '=') !== false) {
                        list($full_name, $lfull_name) = explode('=', $localeFunction);
                        $full_name = trim($full_name);
                        $lfull_name = trim($lfull_name);
                        if ((isset(self::$PHPExcelFunctions[$full_name])) && ($lfull_name != '') && ($full_name != $lfull_name)) {
                            self::$localeFunctions[$full_name] = $lfull_name;
                        }
                    }
                }
